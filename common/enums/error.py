...
from common.enums.unique import keyword_value_unique
...
class _ECEnumMeta(EnumMeta):
    def __new__(mcs, *args, **kwargs):
        ...
        enum_class.__member_codes_ = tuple(enum.value.code for enum in enum_class)
        return enum_class

    @property
    def codes(cls) -> Tuple[str, ...]:
        return cls.__member_codes_
...
#     print(ECData.code)
#     print(_ECEnumMeta)
#     print(ECEnumA.serverError.code)
